...
# ------------ exercise: -----------------
#loop through the dict and print: 
# Ihave <number> of <fruit> for each line. 

fruits.list = inventory.items()   # ([('apples', 100), ('oranges', 500), ('grapes', 200)])


for fruit_item in fruits_list:      # ('apples', 100)
    print(f'I have {fruit_item[1]} of {fruit_item[0]}')

#option 2: 
fruit_names inventory.keys()        #['apples', 'oranges', 'grapes'])
for single_fruit in fruit_names:
    number = inventory[single_fruit]
    print(f'Ihave {number} of {single_fruit}')
...
# dict_keys(['apples', 'oranges', 'grapes'])
...
myitems = inventory.items()  
  #list of tuples
#   >>> myitems
# dict_items([('apples', 100), ('oranges', 500), ('grapes', 200)])

myupdate = inventory.update('apples':200)
